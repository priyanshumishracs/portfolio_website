...
// Animated counters for stats (if you want to add animated numbers)
...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.project-card, .skill-category, .highlight, .timeline-item, .certification-card');
